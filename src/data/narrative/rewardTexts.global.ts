export const rewardTextsGlobal = {
  ...
  reward_expedition_stamp_01: { title: "Expedition Stamp", description: "Proof that this is a real file, not a legend." },
  ...
  reward_artifact_case_01: { title: "Artifact Case", description: "The main discovery starts to gain weight." },
  ...
  reward_artifact_case_major_01: { title: "Disc Container", description: "The main artifact gains physical context." },
  ...
  reward_archive_seal_01: { title: "Archive Seal", description: "The final permission to close the file." },
  reward_finale_bundle_01: { title: "Completed Archive", description: "The disc, the full map, and the restored story." },
} as const;
