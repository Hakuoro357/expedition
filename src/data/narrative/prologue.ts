...
export const PROLOGUE_TEXT: PrologueText = {
  ...
  en: [
    ...
    "A month ago a hunter brought to the district archive a tin box he had found in the ruins of an old winter cabin. Inside were notebooks and a stack of loose pages. Cole's journal, the cartographer Marlowe's field notes, scattered pages from Calder, Mercer, and Reed. Much of it had soaked through, the leaves were jumbled, parts were simply missing. Sometimes only the handwriting tells you who wrote what.",
  ...
  es: [
    ...
    "Hace un mes un cazador trajo al archivo comarcal una caja de hojalata que había encontrado en las ruinas de una vieja cabaña de invernada. Dentro había cuadernos y un fajo de hojas sueltas. El diario de Cole, las notas de campo de la cartógrafa Marlowe, páginas dispersas de Calder, Mercer y Reed. Gran parte estaba empapada, las hojas revueltas, algunas simplemente faltaban. A veces solo la letra te dice quién escribió qué.",
  ...
  pt: [
    ...
    "Há um mês um caçador trouxe ao arquivo distrital uma caixa de lata que havia encontrado nas ruínas de uma velha cabana de inverno. Dentro havia cadernos e um maço de folhas soltas. O diário de Cole, as notas de campo da cartógrafa Marlowe, páginas dispersas de Calder, Mercer e Reed. Muito estava encharcado, as folhas embaralhadas, algumas simplesmente faltavam. Às vezes só a caligrafia diz quem escreveu o quê.",
  ...
  de: [
    ...
    "Vor einem Monat brachte ein Jäger eine Blechkiste ins Bezirksarchiv, die er in den Ruinen einer alten Winterhütte gefunden hatte. Darin lagen Notizbücher und ein Stapel loser Blätter. Coles Tagebuch, die Feldnotizen der Kartografin Marlowe, verstreute Seiten von Calder, Mercer und Reed. Vieles war durchweicht, die Blätter durcheinander, manches fehlte einfach. Manchmal weiß man nur an der Handschrift, wer was geschrieben hat.",
